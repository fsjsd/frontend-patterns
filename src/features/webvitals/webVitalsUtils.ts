...
import {FirstInputPolyfillEntry, getCLS, getFCP, getFID, getLCP, getTTFB, Metric, NavigationTimingPolyfillEntry, ReportHandler} from 'web-vitals';

// adapted from:
// https://github.com/GoogleChromeLabs/web-vitals-report/blob/main/src/js/analytics.js

type WebVitalPerfEntries = (PerformanceEntry | FirstInputPolyfillEntry | NavigationTimingPolyfillEntry)[]
...
export const registerWebVitalsListeners = ({ onCls, onFcp, onLcp, onTtfb, onFid }: RegisterWebVitalsListenersProps) => {
